# LERNPHASE — ETH Block-Exam Knowledge Hub
...
> 🧑‍🎓 **Want to use this for your own exams?** This is a fork-friendly template — file-based notes plus a static, no-backend progress dashboard. See **[ADD-YOUR-OWN-COURSES.md](ADD-YOUR-OWN-COURSES.md)** for a step-by-step guide to retargeting it at your own subjects.
